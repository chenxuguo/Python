...
class ToRomanBadInput(unittest.TestCase):
    ...
    def test_too_large(self):
        ...
        for integer in self.bad_values:
            self.assertRaises(roman5.OutOfRangeError, roman5.to_roman, integer)
    ...
    def test_non_integer(self):
        ...
        self.assertRaises(roman5.NonIntegerError, roman5.to_roman, 0.5)
...
class FromRomanBadInput(unittest.TestCase):
    ...
    def test_repeated_pairs(self):
        ...
        for s in ('IIMXCC', 'VX', 'DCM', 'CMM', 'IXIX',
                  'MCMX', 'XCX', 'IVI', 'LM', 'LD', 'LC'):
            self.assertRaises(roman5.InvalidRomanNumeralError, roman5.from_roman, s)
