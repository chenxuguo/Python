...
import inspect
import time
from typing import Final, overload, ParamSpec, TypeVar, Protocol, Callable, Awaitable
# from typing import reveal_type


async def print_with_timer(format: str, interval: float = 0.2) -> None:
    start = time.time()
    while True:
